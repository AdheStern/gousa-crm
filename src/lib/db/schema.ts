...
export const clientes = pgTable("clientes", {
  ...
  historicoViajes: text("historico_viajes"),
  nombrePatrocinador: varchar("nombre_patrocinador", { length: 255 }),
  direccionPatrocinador: text("direccion_patrocinador"),
  telefonoPatrocinador: varchar("telefono_patrocinador", { length: 50 }),
  emailPatrocinador: varchar("email_patrocinador", { length: 255 }),
  trabajoPatrocinador: varchar("trabajo_patrocinador", { length: 255 }),
  fechaInicioTrabajoPatrocinador: date("fecha_inicio_trabajo_patrocinador"),
  percepcionSalarialPatrocinador: decimal("percepcion_salarial_patrocinador", {
    precision: 10,
    scale: 2,
  }),
  fechaCreacion: timestamp("fecha_creacion").defaultNow().notNull(),
